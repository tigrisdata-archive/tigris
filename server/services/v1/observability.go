...
func (dd Datadog) QueryTimeSeriesMetrics(_ context.Context, req *api.QueryTimeSeriesMetricsRequest) (*api.QueryTimeSeriesMetricsResponse, error) {
	...
	if config.DefaultConfig.Auth.EnableNamespaceIsolation {
		// TODO: add tag to scope query to the right namespace
